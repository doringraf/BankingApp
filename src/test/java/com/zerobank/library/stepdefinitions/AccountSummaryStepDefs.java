...
public class AccountSummaryStepDefs {
    ...
    public void page_should_have_to_following_account_types(String types) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            boardElement = dashboardMenuPage.getBoardHeadByName(items.get(i));
    ...
    public void table_must_have_columns(String tableName, String column1,String column2, String column3) {
        List<String> tableColumns = BrowserUtils.getElementsText(dashboardMenuPage.getTableColumnsByTableName(tableName));
